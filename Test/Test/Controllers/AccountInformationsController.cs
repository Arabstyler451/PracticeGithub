...
namespace Test.Controllers
{
    public class AccountInformationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AccountInformationId,UserId,FullName,PhoneNumber,Email,Password")] AccountInformation accountInformation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountInformationId,UserId,FullName,PhoneNumber,Email,Password")] AccountInformation accountInformation)
        {
