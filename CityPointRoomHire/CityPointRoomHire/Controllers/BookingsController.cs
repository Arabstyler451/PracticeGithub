...
namespace CityPointRoomHire.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookingId,RoomId,UserId,BookingDate,TimeSlot,Status")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingId,RoomId,UserId,BookingDate,TimeSlot,Status")] Booking booking)
        {
