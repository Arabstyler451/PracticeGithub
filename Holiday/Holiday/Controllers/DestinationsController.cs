...
namespace Holiday.Controllers
{
    public class DestinationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DestinationId,City,Country,Description")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinationId,City,Country,Description")] Destination destination)
        {
